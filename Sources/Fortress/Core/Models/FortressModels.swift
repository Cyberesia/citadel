...
/// Hierarchical navigation focus for Fortress (sidebar → map → inspector).
...
public struct ProcessIdentity: Hashable, Sendable, Identifiable {
    ...
    public let codeTeamID: String?
    public let signingStatus: ProcessSigningStatus
...
public struct FortressGeoLocation: Hashable, Sendable {
...
public struct FortressGeoPoint: Equatable, Hashable, Sendable {
    public var latitude: Double
    public var longitude: Double

    public static let defaultOrigin = FortressGeoPoint(latitude: 45.5017, longitude: -73.5673)
...
public struct NetworkStream: Identifiable, Hashable, Sendable {
    ...
    public var geo: FortressGeoLocation?
...
public struct FortressFlowArc: Identifiable, Equatable, Sendable {
    public let id: UUID
    public let origin: FortressGeoPoint
    public let destination: FortressGeoPoint
    public let bytesIn: Int64
    public let bytesOut: Int64
    public let rateIn: Int64
    public let rateOut: Int64
...
public struct FortressAlert: Identifiable {
    public let id = UUID()
    public let stream: NetworkStream
    public let reply: (Bool, Bool) -> Void
}

public struct FortressRollup: Identifiable, Hashable, Sendable {
    public let id: String
    public let label: String
