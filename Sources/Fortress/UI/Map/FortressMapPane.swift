...
/// Fortress map pane — adapts Fortress arcs into the shared CitadelDesign map views.
struct FortressMapPane: View {
    let arcs: [FortressFlowArc]
    let origin: FortressGeoPoint
    @Binding var projection: FortressMapProjection
